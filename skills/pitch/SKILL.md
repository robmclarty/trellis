...
- Any referenced sketches should exist in `.specs/sketches/`, though sketches are not required
...
## Output: `.specs/<feature-name>/pitch.md`
...
**Sketches** — Reference any sketches that informed this pitch. For each, one sentence on what was tested and the verdict. If there are no sketches, that's fine; just omit this section. Don't fabricate sketch references.
