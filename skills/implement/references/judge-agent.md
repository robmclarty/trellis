...
<paste the current checklist from {specsDir}/{feature}/implement-state.md>
...
`{specsDir}/{feature}/implement-state.md` and report it rather than guessing.
...
2. For each criterion marked FAIL or UNCLEAR, add the judge's explanation to
   the iteration log in `{specsDir}/{feature}/implement-state.md`
